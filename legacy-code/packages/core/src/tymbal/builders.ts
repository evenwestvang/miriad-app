 ...
 *
 * @see /spec/tymbal/framing.md for the full specification
 */

import { ulid } from 'ulid';
import type { ArtifactFrame, ArtifactPayload } from './frames.js';
...
export const tymbal = {
   ...
   */
  start(id: string, metadata?: Record<string, unknown>): string {
    const frame: { i: string; m?: Record<string, unknown> } = { i: id };
    if (metadata) {
