// Core types for Cikada frontend
// These will eventually come from @cikada/core once @cicada publishes it
...
export interface Message {
  ...
  formData?: import('@cikada/core').StructuredAskFormData
  formState?: import('@cikada/core').StructuredAskFormState
