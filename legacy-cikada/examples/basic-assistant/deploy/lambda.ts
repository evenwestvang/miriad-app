 ...
 * Lambda Entry Point
 *
 * This bundles all handlers and agents for AWS deployment.
 */
...
// =============================================================================
// Define Agents (same as local example)
// =============================================================================
...
// HTTP handlers
export { sendMessageHandler, startThreadHandler };

// Process handler with Lambda Durable execution
export const agentHandler = withDurableExecution(createDurableProcessHandler());
