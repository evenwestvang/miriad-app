...
/**
 * OAuth configuration from system.mcp artifact props.
 */
...
const metadataCache = new Map<
  string,
  { metadata: OAuthServerMetadata; timestamp: number }
>();
...
export async function resolveOAuthEndpoints(
  ...
  return {
    authorizationEndpoint:
      authConfig?.authorizationEndpoint ?? metadata.authorization_endpoint,
