 ...
 * OAuth Token Storage
 *
 * Persists OAuth tokens to the filesystem at ~/.cikada/oauth-tokens/
 ...
 */
const CIKADA_DIR = process.env.CIKADA_DIR || path.join(os.homedir(), ".cikada");

/**
 * Directory for OAuth tokens.
 */
const TOKENS_DIR = path.join(CIKADA_DIR, "oauth-tokens");
