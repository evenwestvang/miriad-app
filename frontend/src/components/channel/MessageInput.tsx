...
export function MessageInput({
  ...
  const { findMentionTrigger, getOptionsCount, getOptionAtIndex } = useMentionAutocomplete(roster, globalAgents, mentionHistory)
  ...
  const handleKeyDown = useCallback(
    ...
    [
      ...
      insertMention, handleSubmit, isRosterEmpty, sendModePending, handleSendModeSelect
    ]
  )
