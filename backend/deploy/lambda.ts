...
console.log(`[Lambda] FLY_API_TOKEN: length=${FLY_API_TOKEN.length}, starts_with=${FLY_API_TOKEN.substring(0, 10)}`);
...
const FLY_MEMORY_MB = parseInt(process.env.FLY_MEMORY_MB ?? '8192', 10);
